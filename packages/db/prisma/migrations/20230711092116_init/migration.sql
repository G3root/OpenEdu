...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('OWNER', 'ADMIN', 'TEACHER', 'STUDENT', 'GUEST');
...
-- AddForeignKey
ALTER TABLE "Membership" ADD CONSTRAINT "Membership_inviter_fkey" FOREIGN KEY ("inviter") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
